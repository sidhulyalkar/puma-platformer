...
| [Hollow Knight official site](https://www.hollowknight.com/), [Silksong official site](https://hollowknightsilksong.com/), and [Celeste official site](https://www.celestegame.com/) | Official descriptions of interconnected exploration, acrobatic action, and handcrafted platforming. | Design interpretation for optional objective rooms, committed movement combinations, visible mechanism feedback, and persistent return-route rewards. Original implementation; no source or assets copied. See [Moontrail](MOONTRAIL.md). |
| [Silksong Reaper Crest reference](https://hollowknight.wiki/w/Reaper_Crest) | User-specified reference for broad sweeping attacks and a deliberate combat rhythm. | Design inspiration for committed claw sweeps and aerial follow-ups. Wildbound uses original feline moves, tuning, names, art, and hunting/light mechanics; no Silksong code, animation, audio, or assets are included. |
