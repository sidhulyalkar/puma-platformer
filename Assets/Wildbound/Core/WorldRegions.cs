namespace Wildbound.Core
{
    public sealed partial class WorldDefinition
    {
        ...
        private static void BuildCanopy(WorldDefinition w)
        {
            ...
            w.Enemies.Add(new Enemy(EnemyKind.Thornling, 30.5f, 1, 1.0f));
            w.Enemies.Add(new Enemy(EnemyKind.Bristleback, 71, 1, 2));
            w.Enemies.Add(new Enemy(EnemyKind.ReedSpitter, 55, 5));
            w.Enemies.Add(new Enemy(EnemyKind.ReedSpitter, 73, 1));
            w.Encounters.Add(new EncounterPack(EncounterPattern.StaggerTell, 28, 1, 8f).Add(2).Add(3));
        ...
        private static void BuildGrotto(WorldDefinition w)
        {
            ...
            w.Enemies.Add(new Enemy(EnemyKind.LanternMoth, 24, 12.5f, 1));
            w.Enemies.Add(new Enemy(EnemyKind.LanternMoth, 47.5f, 5.5f, 1));
            w.Enemies.Add(new Enemy(EnemyKind.ReedSpitter, 63, 1));
            w.Enemies.Add(new Enemy(EnemyKind.Thornling, 50, 1, 1.1f));
            w.Encounters.Add(new EncounterPack(EncounterPattern.TwinDive, 22, 11, 9f).Add(2).Add(3));
            w.Encounters.Add(new EncounterPack(EncounterPattern.ShelfAmbush, 50, 4, 9f).Add(4).Add(6));
        ...
        private static void BuildSky(WorldDefinition w)
        {
            ...
            w.Enemies.Add(new Enemy(EnemyKind.Thornling, 43.5f, 1, 1));
            w.Enemies.Add(new Enemy(EnemyKind.LanternMoth, 42, 18, 1));
            w.Enemies.Add(new Enemy(EnemyKind.LanternMoth, 48, 19, 1));
            w.Enemies.Add(new Enemy(EnemyKind.LanternMoth, 47.5f, 5.5f, 1));
            w.Enemies.Add(new Enemy(EnemyKind.ReedSpitter, 68, 6));
            w.Encounters.Add(new EncounterPack(EncounterPattern.StaggerTell, 41, 1, 8f).Add(2).Add(3));
            w.Encounters.Add(new EncounterPack(EncounterPattern.TwinDive, 45, 18, 10f).Add(4).Add(5));
        ...
        private static void BuildCinder(WorldDefinition w)
        {
            ...
            w.Enemies.Add(new Enemy(EnemyKind.Thornling, 25, 1, 1.0f));
            ...
            w.Enemies.Add(new Enemy(EnemyKind.LanternMoth, 46, 16.5f, 1));
            w.Encounters.Add(new EncounterPack(EncounterPattern.StaggerTell, 23, 1, 8f).Add(2).Add(3));
            w.Encounters.Add(new EncounterPack(EncounterPattern.Pincer, 55, 1, 11f).Add(4).Add(6));
            w.Encounters.Add(new EncounterPack(EncounterPattern.TwinDive, 44, 17, 10f).Add(7).Add(8));
